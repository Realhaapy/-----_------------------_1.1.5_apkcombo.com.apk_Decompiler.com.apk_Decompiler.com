...
public final class w extends a<w> implements Serializable {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: r.b.a.u.w.a.<clinit>():void");
        }
    }
    ...
    private long M() {
        return ((((long) N()) * 12) + ((long) this.f5650e.Q())) - 1;
    }

    private int N() {
        return this.f5650e.S() + 543;
    }

    static b U(DataInput dataInput) {
        return v.f5646g.x(dataInput.readInt(), dataInput.readByte(), dataInput.readByte());
    }

    private w V(f fVar) {
        return fVar.equals(this.f5650e) ? this : new w(fVar);
    }
    ...
    /* renamed from: O */
    public w m(long j2, l lVar) {
        return (w) super.m(j2, lVar);
    }

    /* renamed from: P */
    public w s(long j2, l lVar) {
    ...
    /* renamed from: R */
    public w H(long j2) {
        return V(this.f5650e.f0(j2));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: S */
    public w I(long j2) {
        return V(this.f5650e.g0(j2));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: T */
    public w J(long j2) {
        return V(this.f5650e.i0(j2));
    }

    /* renamed from: W */
    public w h(r.b.a.x.f fVar) {
    ...
    public r.b.a.u.w k(r.b.a.x.i r8, long r9) {
        /*
            r7 = this;
        ...
        L_0x0053:
            r.b.a.f r0 = r7.f5650e
            r.b.a.f r8 = r0.k(r8, r9)
            r.b.a.u.w r8 = r7.V(r8)
            return r8
        L_0x005e:
            r.b.a.f r8 = r7.f5650e
            int r9 = r7.N()
            int r1 = r1 - r9
            int r1 = r1 + -543
            r.b.a.f r8 = r8.q0(r1)
        ...
        L_0x0093:
            ...
            r.b.a.u.w r8 = (r.b.a.u.w) r8
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: r.b.a.u.w.k(r.b.a.x.i, long):r.b.a.u.w");
    }
    ...
    public n d(i iVar) {
        ...
        if (j(iVar)) {
            ...
            if (i2 == 1 || i2 == 2 || i2 == 3) {
                return this.f5650e.d(iVar);
            }
            if (i2 != 4) {
                return x().A(aVar);
            }
            n k2 = r.b.a.x.a.YEAR.k();
            return n.i(1, N() <= 0 ? (-(k2.d() + 543)) + 1 : 543 + k2.c());
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof w) {
            return this.f5650e.equals(((w) obj).f5650e);
        }
        return false;
    }

    public int hashCode() {
        return x().l().hashCode() ^ this.f5650e.hashCode();
    }
    ...
    public final c<w> v(r.b.a.h hVar) {
        return super.v(hVar);
    }
}
