...
public final class MatcherUtils {
    ...
    private final boolean wildcardMatch(String str, String str2) {
        if (!q.w(str2, "*", false, 2, (Object) null)) {
            return false;
        }
        if (l.a(str2, "*")) {
            return true;
        ...
        String str3 = str2;
        if (q.F(str3, "*", 0, false, 6, (Object) null) == q.K(str3, "*", 0, false, 6, (Object) null) && p.k(str2, "*", false, 2, (Object) null)) {
            Objects.requireNonNull(str2, "null cannot be cast to non-null type java.lang.String");
            String substring = str2.substring(0, str2.length() - 1);
            l.c(substring, "(this as java.lang.Strin…ing(startIndex, endIndex)");
            return p.t(str, substring, false, 2, (Object) null);
        }
    ...
    public final boolean areActivityOrIntentComponentsMatching$window_release(Activity activity, ComponentName componentName) {
        ...
        l.d(componentName, "ruleComponent");
    ...
    public final boolean areComponentsMatching$window_release(android.content.ComponentName r7, android.content.ComponentName r8) {
        ...
        L_0x0022:
            ...
            r4 = 2
            r5 = 0
            boolean r0 = m.d0.q.w(r3, r0, r2, r4, r5)
            r0 = r0 ^ r1
            if (r0 == 0) goto L_0x008f
            java.lang.String r0 = r7.getPackageName()
            java.lang.String r3 = r8.getPackageName()
            boolean r0 = m.y.d.l.a(r0, r3)
