...
public final class SplitRuleParser {
    private final ComponentName buildClassName(String str, CharSequence charSequence) {
        if (charSequence != null) {
            if (!(charSequence.length() == 0)) {
                ...
                if (obj.charAt(0) == '.') {
                    return new ComponentName(str, l.j(str, obj));
                }
                int E = q.E(obj, '/', 0, false, 6, (Object) null);
                if (E > 0) {
                    ...
                    l.c(obj, "(this as java.lang.String).substring(startIndex)");
                    str = substring;
                }
                if (l.a(obj, "*") || q.E(obj, '.', 0, false, 6, (Object) null) >= 0) {
    ...
    private final SplitPairRule parseSplitPairRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        return new SplitPairRule(e0.b(), obtainStyledAttributes.getBoolean(R.styleable.SplitPairRule_finishPrimaryWithSecondary, false), obtainStyledAttributes.getBoolean(R.styleable.SplitPairRule_finishSecondaryWithPrimary, true), obtainStyledAttributes.getBoolean(R.styleable.SplitPairRule_clearTop, false), dimension, dimension2, f2, i2);
    }
    ...
    private final SplitPlaceholderRule parseSplitPlaceholderRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        l.c(component, "Intent().setComponent(pl…eholderActivityClassName)");
    ...
    private final java.util.Set<androidx.window.embedding.EmbeddingRule> parseSplitXml(android.content.Context r9, int r10) {
        /*
            ...
            m.y.d.l.c(r10, r0)     // Catch:{ NotFoundException -> 0x00ec }
