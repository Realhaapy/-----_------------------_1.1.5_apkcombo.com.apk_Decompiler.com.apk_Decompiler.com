...
public final class SplitPairRule extends SplitRule {
    ...
    public /* synthetic */ SplitPairRule(java.util.Set r8, boolean r9, boolean r10, boolean r11, int r12, int r13, float r14, int r15, int r16, m.y.d.g r17) {
        /*
            r7 = this;
            r0 = r16
            r1 = r0 & 2
        ...
        L_0x0034:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.window.embedding.SplitPairRule.<init>(java.util.Set, boolean, boolean, boolean, int, int, float, int, int, m.y.d.g):void");
    }
    ...
    public final SplitPairRule plus$window_release(SplitPairFilter splitPairFilter) {
        ...
        return new SplitPairRule(r.G(linkedHashSet), this.finishPrimaryWithSecondary, this.finishSecondaryWithPrimary, this.clearTop, getMinWidth(), getMinSmallestWidth(), getSplitRatio(), getLayoutDirection());
    }
}
