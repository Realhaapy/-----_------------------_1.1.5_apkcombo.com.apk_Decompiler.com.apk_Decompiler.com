...
public enum c {
    ...
    private static final Map<Integer, c> H = null;
    private static final Map<String, c> I = null;
    ...
    static {
        ...
        I = new HashMap();
        for (c cVar : values()) {
            for (int valueOf : cVar.f4485e) {
                H.put(Integer.valueOf(valueOf), cVar);
            }
            I.put(cVar.name(), cVar);
            for (String put : cVar.f4486f) {
                I.put(put, cVar);
            }
        }
    }
