...
class FlutterEngineConnectionRegistry implements PluginRegistry, ActivityControlSurface, ServiceControlSurface, BroadcastReceiverControlSurface, ContentProviderControlSurface {
    ...
    private static class FlutterEngineActivityPluginBinding implements ActivityPluginBinding {
        ...
        public FlutterEngineActivityPluginBinding(Activity activity2, e eVar) {
            this.activity = activity2;
            this.hiddenLifecycleReference = new HiddenLifecycleReference(eVar);
        }
    ...
    private static class FlutterEngineServicePluginBinding implements ServicePluginBinding {
        ...
        FlutterEngineServicePluginBinding(Service service2, e eVar) {
            this.service = service2;
            this.hiddenLifecycleReference = eVar != null ? new HiddenLifecycleReference(eVar) : null;
        }
    ...
    private void attachToActivityInternal(Activity activity, e eVar) {
        this.activityPluginBinding = new FlutterEngineActivityPluginBinding(activity, eVar);
    ...
    public void attachToActivity(ExclusiveAppComponent<Activity> exclusiveAppComponent, e eVar) {
        ...
        try {
            ...
            attachToActivityInternal(exclusiveAppComponent.getAppComponent(), eVar);
        } finally {
            TraceSection.end();
        }
    }

    public void attachToBroadcastReceiver(BroadcastReceiver broadcastReceiver2, e eVar) {
    ...
    public void attachToContentProvider(ContentProvider contentProvider2, e eVar) {
    ...
    public void attachToService(Service service2, e eVar, boolean z) {
        TraceSection.begin("FlutterEngineConnectionRegistry#attachToService");
        try {
            detachFromAppComponent();
            this.service = service2;
            this.servicePluginBinding = new FlutterEngineServicePluginBinding(service2, eVar);
