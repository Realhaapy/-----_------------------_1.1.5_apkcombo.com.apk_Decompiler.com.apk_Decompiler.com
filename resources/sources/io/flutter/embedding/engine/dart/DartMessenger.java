...
class DartMessenger implements BinaryMessenger, PlatformMessageHandler {
    ...
    static class Reply implements BinaryMessenger.BinaryReply {
        ...
        Reply(FlutterJNI flutterJNI2, int i2) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public /* synthetic */ void b(String str, HandlerInfo handlerInfo, ByteBuffer byteBuffer, int i2, long j2) {
    ...
    private void dispatchMessageToQueue(String str, HandlerInfo handlerInfo, ByteBuffer byteBuffer, int i2, long j2) {
        ...
        c cVar = new c(this, str, handlerInfo, byteBuffer, i2, j2);
        if (dartMessengerTaskQueue == null) {
            dartMessengerTaskQueue = this.platformTaskQueue;
        }
        dartMessengerTaskQueue.dispatch(cVar);
    }
    ...
    private void invokeHandler(HandlerInfo handlerInfo, ByteBuffer byteBuffer, int i2) {
        if (handlerInfo != null) {
            try {
    ...
    public /* synthetic */ BinaryMessenger.TaskQueue makeBackgroundTaskQueue() {
        return a.$default$makeBackgroundTaskQueue(this);
    }
