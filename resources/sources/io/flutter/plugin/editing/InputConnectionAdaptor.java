...
public class InputConnectionAdaptor extends BaseInputConnection implements ListenableEditingState.EditingStateWatcher {
    ...
    public InputConnectionAdaptor(View view, int i2, TextInputChannel textInputChannel2, KeyboardDelegate keyboardDelegate2, ListenableEditingState listenableEditingState, EditorInfo editorInfo) {
        this(view, i2, textInputChannel2, keyboardDelegate2, listenableEditingState, editorInfo, new FlutterJNI());
    }

    public InputConnectionAdaptor(View view, int i2, TextInputChannel textInputChannel2, KeyboardDelegate keyboardDelegate2, ListenableEditingState listenableEditingState, EditorInfo editorInfo, FlutterJNI flutterJNI) {
        super(view, true);
