...
public class e<K, V> {
    ...
    public final V c(K r5) {
        /*
            ...
            monitor-enter(r4)
            java.util.LinkedHashMap<K, V> r0 = r4.a     // Catch:{ all -> 0x0054 }
            java.lang.Object r0 = r0.get(r5)     // Catch:{ all -> 0x0054 }
            if (r0 == 0) goto L_0x0016
            int r5 = r4.f3264g     // Catch:{ all -> 0x0054 }
            int r5 = r5 + 1
            r4.f3264g = r5     // Catch:{ all -> 0x0054 }
            monitor-exit(r4)     // Catch:{ all -> 0x0054 }
            return r0
        L_0x0016:
            int r0 = r4.f3265h     // Catch:{ all -> 0x0054 }
            int r0 = r0 + 1
            r4.f3265h = r0     // Catch:{ all -> 0x0054 }
            monitor-exit(r4)     // Catch:{ all -> 0x0054 }
        ...
        L_0x0025:
            monitor-enter(r4)
            int r1 = r4.f3262e     // Catch:{ all -> 0x0051 }
            int r1 = r1 + 1
            r4.f3262e = r1     // Catch:{ all -> 0x0051 }
            java.util.LinkedHashMap<K, V> r1 = r4.a     // Catch:{ all -> 0x0051 }
            java.lang.Object r1 = r1.put(r5, r0)     // Catch:{ all -> 0x0051 }
            if (r1 == 0) goto L_0x003a
            java.util.LinkedHashMap<K, V> r2 = r4.a     // Catch:{ all -> 0x0051 }
            r2.put(r5, r1)     // Catch:{ all -> 0x0051 }
            goto L_0x0043
        L_0x003a:
            int r2 = r4.b     // Catch:{ all -> 0x0051 }
    ...
    public void g(int r5) {
        ...
        L_0x001e:
            ...
            int r2 = r4.f3263f     // Catch:{ all -> 0x0071 }
            r3 = 1
            int r2 = r2 + r3
            r4.f3263f = r2     // Catch:{ all -> 0x0071 }
        ...
        L_0x0071:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: e.e.e.g(int):void");
    }
    ...
    public final synchronized String toString() {
        ...
        i2 = this.f3264g;
        i3 = this.f3265h + i2;
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.c), Integer.valueOf(this.f3264g), Integer.valueOf(this.f3265h), Integer.valueOf(i3 != 0 ? (i2 * 100) / i3 : 0)});
    }
}
