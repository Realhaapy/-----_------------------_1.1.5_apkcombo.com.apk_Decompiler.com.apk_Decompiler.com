...
public class d {
    ...
    private static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) {
        ...
        L_0x005d:
            ...
            r15.<init>()
            int[] r0 = e.r.a.a.a.f3643h
            r7 = r22
            android.content.res.TypedArray r6 = e.f.j.f.k.k(r8, r9, r7, r0)
            java.lang.String r0 = "ordering"
            int r16 = e.f.j.f.k.g(r6, r10, r0, r14, r14)
            r0 = r18
            r1 = r19
            r2 = r20
            r3 = r21
        ...
        L_0x0106:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: e.r.a.a.d.b(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int, float):android.animation.Animator");
    }
    ...
    private static android.animation.PropertyValuesHolder e(android.content.res.TypedArray r11, int r12, int r13, int r14, java.lang.String r15) {
        ...
        L_0x003c:
            ...
            e.f.k.c$b[] r13 = e.f.k.c.d(r12)
            e.f.k.c$b[] r14 = e.f.k.c.d(r11)
            if (r13 != 0) goto L_0x0054
            if (r14 == 0) goto L_0x0167
        L_0x0054:
            if (r13 == 0) goto L_0x0098
            e.r.a.a.d$a r0 = new e.r.a.a.d$a
            r0.<init>()
            if (r14 == 0) goto L_0x008d
            boolean r3 = e.f.k.c.b(r13, r14)
        ...
        L_0x0098:
            if (r14 == 0) goto L_0x0167
            e.r.a.a.d$a r11 = new e.r.a.a.d$a
            r11.<init>()
        ...
        L_0x0167:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: e.r.a.a.d.e(android.content.res.TypedArray, int, int, int, java.lang.String):android.animation.PropertyValuesHolder");
    }
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k2 = k.k(resources, theme, attributeSet, a.f3645j);
        int i2 = 0;
        TypedValue l2 = k.l(k2, xmlPullParser, "value", 0);
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f2, XmlPullParser xmlPullParser) {
        TypedArray k2 = k.k(resources, theme, attributeSet, a.f3642g);
        TypedArray k3 = k.k(resources, theme, attributeSet, a.f3646k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, k2, k3, f2, xmlPullParser);
        int h2 = k.h(k2, xmlPullParser, "interpolator", 0, 0);
        if (h2 > 0) {
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i2, XmlPullParser xmlPullParser) {
        TypedArray k2 = k.k(resources, theme, attributeSet, a.f3645j);
        float f2 = k.f(k2, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue l2 = k.l(k2, xmlPullParser, "value", 0);
        boolean z = l2 != null;
        if (i2 == 4) {
            i2 = (!z || !h(l2.type)) ? 0 : 3;
        }
        Keyframe ofInt = z ? i2 != 0 ? (i2 == 1 || i2 == 3) ? Keyframe.ofInt(f2, k.g(k2, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(f2, k.f(k2, xmlPullParser, "value", 0, 0.0f)) : i2 == 0 ? Keyframe.ofFloat(f2) : Keyframe.ofInt(f2);
        int h2 = k.h(k2, xmlPullParser, "interpolator", 1, 0);
        if (h2 > 0) {
    ...
    private static android.animation.PropertyValuesHolder o(android.content.Context r9, android.content.res.Resources r10, android.content.res.Resources.Theme r11, org.xmlpull.v1.XmlPullParser r12, java.lang.String r13, int r14) {
        ...
        L_0x00dc:
            ...
            e.r.a.a.e r9 = e.r.a.a.e.a()
            r0.setEvaluator(r9)
        L_0x00e9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: e.r.a.a.d.o(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, java.lang.String, int):android.animation.PropertyValuesHolder");
    }
    ...
    private static android.animation.PropertyValuesHolder[] p(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) {
        ...
        L_0x0016:
            ...
            int[] r0 = e.r.a.a.a.f3644i
            r11 = r18
            r12 = r19
            r13 = r21
            android.content.res.TypedArray r14 = e.f.j.f.k.k(r11, r12, r13, r0)
            java.lang.String r0 = "propertyName"
            java.lang.String r15 = e.f.j.f.k.i(r14, r6, r0, r1)
            r0 = 4
            java.lang.String r1 = "valueType"
            int r5 = e.f.j.f.k.g(r14, r6, r1, r2, r0)
            r0 = r17
            r1 = r18
            r2 = r19
            r3 = r20
        ...
        L_0x007f:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: e.r.a.a.d.p(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet):android.animation.PropertyValuesHolder[]");
    }
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f2, XmlPullParser xmlPullParser) {
        long g2 = (long) k.g(typedArray, xmlPullParser, "duration", 1, 300);
        long g3 = (long) k.g(typedArray, xmlPullParser, "startOffset", 2, 0);
        int g4 = k.g(typedArray, xmlPullParser, "valueType", 7, 4);
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i2, float f2, XmlPullParser xmlPullParser) {
        ...
        String i3 = k.i(typedArray, xmlPullParser, "pathData", 1);
        if (i3 != null) {
            String i4 = k.i(typedArray, xmlPullParser, "propertyXName", 2);
            String i5 = k.i(typedArray, xmlPullParser, "propertyYName", 3);
            if (i2 != 2) {
            }
            if (i4 == null && i5 == null) {
