...
public final class l {
    ...
    static class a {
        ...
        static MenuItem g(MenuItem menuItem, char c, int i2) {
        ...
        static MenuItem k(MenuItem menuItem, char c, int i2) {
            return menuItem.setNumericShortcut(c, i2);
        }

        static MenuItem l(MenuItem menuItem, char c, char c2, int i2, int i3) {
