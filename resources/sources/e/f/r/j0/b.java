...
public final class b {
    ...
    class a extends InputConnectionWrapper {
        ...
        public boolean commitContent(InputContentInfo inputContentInfo, int i2, Bundle bundle) {
            if (this.a.a(c.f(inputContentInfo), i2, bundle)) {
                return true;
            }
    ...
    /* renamed from: e.f.r.j0.b$b  reason: collision with other inner class name */
    class C0082b extends InputConnectionWrapper {
        final /* synthetic */ c a;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        C0082b(InputConnection inputConnection, boolean z, c cVar) {
            super(inputConnection, z);
            this.a = cVar;
        }
    ...
    public static InputConnection a(InputConnection inputConnection, EditorInfo editorInfo, c cVar) {
        e.f.q.c.d(inputConnection, "inputConnection must be non-null");
        e.f.q.c.d(editorInfo, "editorInfo must be non-null");
        e.f.q.c.d(cVar, "onCommitContentListener must be non-null");
        return Build.VERSION.SDK_INT >= 25 ? new a(inputConnection, false, cVar) : a.a(editorInfo).length == 0 ? inputConnection : new C0082b(inputConnection, false, cVar);
    }

    /* JADX WARNING: Removed duplicated region for block: B:46:0x007d  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static boolean b(java.lang.String r7, android.os.Bundle r8, e.f.r.j0.b.c r9) {
        /*
            r0 = 0
        ...
        L_0x005e:
            ...
            e.f.r.j0.c r8 = new e.f.r.j0.c     // Catch:{ all -> 0x0077 }
        ...
        L_0x0081:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: e.f.r.j0.b.b(java.lang.String, android.os.Bundle, e.f.r.j0.b$c):boolean");
    }
}
